...
interface GrainientUniforms {
  ...
  uCenterOffset: { value: THREE.Vector2 };
  uZoom: { value: number };
...
function getUniforms(material: THREE.RawShaderMaterial): GrainientUniforms {
...
export function Grainient({
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      ...
      getUniforms(material).iResolution.value.set(ctx.drawingBufferWidth, ctx.drawingBufferHeight);

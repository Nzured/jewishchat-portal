...
import { GrowthSnapshot } from "./_components/GrowthSnapshot";
import { InsightsHeader } from "./_components/InsightsHeader";
import { ALL_CATEGORIES, ListingGrowth } from "./_components/ListingGrowth";
import { LiveGroupsByCategory } from "./_components/LiveGroupsByCategory";
import { ModerationOperations } from "./_components/ModerationOperations";
import { PERIOD_HINT_LABEL, PERIOD_TO_API, type PeriodSelection } from "./_components/PeriodToggle";
import { PlatformTraffic } from "./_components/PlatformTraffic";
import { UserReports } from "./_components/UserReports";
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    ...
    let ignore = false;
    const requestKey = [periodParams.period, periodParams.startDate, periodParams.endDate].join(
      "|",
    );
